...
<body>
    ...
    <form action="${pageContext.request.contextPath}/generateHourseRentContact/createContract.do" method="post" class="form form-horizontal" id="demoform-1">
        <legend>房屋契约（简要）</legend> ${AccountMessage}
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">甲方（用户）：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input name="userName" type="text" class="input-text" autocomplete="off" placeholder="不可写" value="${userName}" readonly="readonly">
                <input type="hidden" class="input-text" autocomplete="off" placeholder="帐号" value="${userId}"readonly="readonly">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input name="masterId" type="hidden" class="input-text" autocomplete="off" placeholder="帐号" value="${hc.masterId}" readonly="readonly">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">单个月房租</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input name="singleMoney"type="text" class="input-text" autocomplete="off" placeholder="不可写" value="${hc.singleMoney}" readonly="readonly">
                <input type="hidden" class="input-text" autocomplete="off" placeholder="帐号" value="${userId}"readonly="readonly">
                <input type="hidden"  name="hourseId" class="input-text" autocomplete="off" placeholder="帐号" value="${hc.hourseId}"readonly="readonly">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">提交訂單</label>
